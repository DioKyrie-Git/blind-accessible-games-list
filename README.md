...
- [Crusader Kings III](https://store.steampowered.com/app/1158310/Crusader_Kings_III/), PC, with [this mod](https://forum.paradoxplaza.com/forum/threads/mod-ocr-support-a-mod-for-blind-and-visually-impaired-players.1619475/)) - fully accessible with OCR. This means that everything can be played, but the mod relies on using live OCR instead of directly outputting text to a tts.
- [Cryptmaster](https://store.steampowered.com/app/1885110/Cryptmaster/), PC, with [the Cryptmaster Access mod](https://github.com/zersiax/CryptmasterAccess)) - work in progress, under active development
- [Cyber Punk 2077](https://store.steampowered.com/app/1091500/Cyberpunk_2077/), PC, with [the Cyber Punk Access mod](https://www.nexusmods.com/cyberpunk2077/mods/31539?tab=description)) - work in progress, under active development
- [Darkest Dungeon](https://store.steampowered.com/app/262060/Darkest_Dungeon/), PC, with [the Blindest Dungeon mod](https://github.com/Vicorin/Blindest-Dungeon)) - base game fully accessible, with most DLC content also being fully accessible. Check the mod link for more details
- [Darkest Dungeon II](https://store.steampowered.com/app/1940340/Darkest_Dungeon_II/), PC, with [the Harkest Dungeon mod](https://amerikrainian.com/harkest-dungeon/)) - fully accessible
- [Date Everything!](https://store.steampowered.com/app/2201320/Date_Everything/), PC, with [the Date Everything Access mod](https://github.com/ObjectInSpace/date-everything-access)) - work in progress, under active development
- [DawnCaster](https://store.steampowered.com/app/3966890/Dawncaster__The_RPG_Cardventure/), PC/Android/iOS) - fully accessible w/audio description
- [Death and Taxes](https://store.steampowered.com/app/1166290/Death_and_Taxes/), PC, with [the Death and Access mod](https://github.com/ObjectInSpace/Death-and-access/)) - mostly accessible
- [Deep Rock Galactic Survivor](https://store.steampowered.com/app/2321470/Deep_Rock_Galactic_Survivor/), PC, with [the DRG Access mod](https://github.com/Ali-Bueno/drg-access/)) - work in progress, under active development
- [Diablo](https://www.gog.com/en/game/diablo), PC, with [the Diablo Access mod](https://github.com/mojsior/diablo-access/)) - mostly accessible
- [Diablo IV](https://diablo4.blizzard.com/), all platforms) - mostly accessible, requires mental mapping in dungeons, nav assist only in overworld for now
...
- [Final Fantasy IV](https://store.steampowered.com/app/1173800/FINAL_FANTASY_IV/), PC, with [the FF4 Screen Reader mod](https://github.com/bladestorm360/FF4-Screen-Reader)) - mostly accessible, click the mod link for more information
- [Final Fantasy IX](https://store.steampowered.com/app/377840/FINAL_FANTASY_IX/), PC, with [this fork of the Memoria engine](https://github.com/BlindGuyNW/FF6ScreenReader), download separately available [here](https://www.dropbox.com/scl/fo/020slj7xgabc2m2ynnuw0/AFj01-ZzB67TcSx2wa0mLtA?rlkey=ngodiwk2wdsh8eaieuj0rrxdl&dl=1)) - work in progress, development paused indefinitely
- [Final Fantasy V](https://store.steampowered.com/app/1173810/FINAL_FANTASY_V/), PC, with [the FF5 screen reader mod](https://github.com/bladestorm360/FF5-Screen-Reader)) - mostly accessible, fully completable
- [Final Fantasy VI](https://store.steampowered.com/app/1173820/FINAL_FANTASY_VI/), PC, with [the FF6 Screen Reader mod](https://github.com/BlindGuyNW/FF6ScreenReader)) - mostly accessible, fully completeable
- [Fire Emblem Sacred Stones](https://www.nintendo.com/en-gb/Games/Game-Boy-Advance/Fire-Emblem-The-Sacred-Stones-266749.html), PC, with [this mod](https://github.com/StanHash/GBA-Fire-Embem-for-Screen-Readers)) - partially accessible, development status unclear
- [Firebird](https://store.steampowered.com/app/1633860/Firebird/), PC) - fully accessible
- [Football Simulator](https://store.steampowered.com/app/1488560/Football_Simulator/), with [the Football Simulator Access mod](https://github.com/PawsTogetherGaming/FootballSimulatorAccessMod)) - mostly accessible
- [Football Manager 26](https://www.footballmanager.com/games/football-manager-26), PC, with [the Football Manager 2026 Access mod](https://github.com/DnDeezNuts/Football-Manager-2026-Access)) - work in progress, under active development
...
- [Hand of Fate](https://store.steampowered.com/app/266510/Hand_of_Fate/), PC, with [the hand of Fate Access mod](https://github.com/rashadnaqeeb/hand-of-fate-access)) - work in progress, under active development
...
- [Iron Lung](https://store.steampowered.com/app/1846170/Iron_Lung/), PC, with [this mod](https://github.com/liliancoghlan1-tech/iron-lung-accessibility)) - fully accessible
...
- [Life is Strange: Before the Storm](https://store.steampowered.com/agecheck/app/554620/), PC, with [the Before the Storm Access mod](https://github.com/ObjectInSpace/BeforeTheStormAccess)) - fully accessible
...
- [Minecraft: Java Edition](https://www.minecraft.net/en-us/store/minecraft-java-bedrock-edition-pc), PC
  - with [the Minecraft Access mod](https://mcaccess.org)) - playable, requires decent spatial awareness
  - with [the United Minecraft mod](https://github.com/blindgoofball/united-Minecraft) - work in progress, under active development
- [Monster Prom](https://store.steampowered.com/app/743450/Monster_Prom/), PC, with [this mod](https://github.com/shaysters/MonsterProm-Accessibility-Mod)) - limited information
- [Monster Train](https://store.steampowered.com/app/1102190/Monster_Train/), PC, with [this mod](https://github.com/ogomez92/monster_tra11y/)) - work in progress, under active development
- [Monster Train 2](https://store.steampowered.com/app/2742830/Monster_Train_2/), PC, with [the MT2 Access mod](https://github.com/amerikrainian/mt2-access)) - work in progress, under active development
- [Moonlight Peaks](https://store.steampowered.com/app/2209900/Moonlight_Peaks/), PC, with [the Moonlight Access mod](https://www.nexusmods.com/moonlightpeaks/mods/137)) - work in progress, under active development
- [Mortal Kombat 1](https://store.steampowered.com/app/1971870/Mortal_Kombat_1/), all platforms) - fully accessible w/audio description
...
- (Osu!](https://osu.ppy.sh), PC, with [this fork](https://osu.heavenay.com/)) - mania, tyco and catch are fully accessible, the classic mode is not accessible
...
- [Stardew Valley](https://store.steampowered.com/app/413150/Stardew_Valley/), PC, with [the Stardew Access mod](https://github.com/stardew-access/stardew-access)) - mostly accessible with downsides being related to combat and efficiency when doing some tasks compared to sighted players. Most of that can be fixed with other mods though.
- [Star Wars: Knights of the Old Republic], PC, with [the Voice of the Old Republic mod](https://github.com/JeanStiletto/voice-of-the-old-republic)) - fully accessible
...
- [Super Robot Wars Y](https://store.steampowered.com/app/1909950/SUPER_ROBOT_WARS_Y/), PC, with [the SRWY Access mod](https://github.com/stephenso1120-cmyk/SRWY-Accessibility/)) - mostly accessible
- [Tangledeep](https://store.steampowered.com/app/628770/Tangledeep/), PC, with [the Tangledeep Access mod](https://github.com/Destranis/tangledeep_access)) - work in progress, under active development
- [TCG Card Shop Simulator Prologue](https://store.steampowered.com/app/3103840/TCG_Card_Shop_Simulator_Prologue/), PC, with [the TCG Card Shop Simulator Prologue Access mod](https://github.com/RogueEugor/TCG-Card-Shop-Simulator-Prologue-Access)) - mostly accessible
- [Terraria](https://store.steampowered.com/app/105600/Terraria/), PC, with [the Terraria Access mod](https://github.com/ChipsAhoiMcCoy/TerrariaAccess)) - mostly accessible
- The Banner Saga (https://store.steampowered.com/app/237990/The_Banner_Saga/), PC, with [this mod](http://n0n0ce.free.fr/TBS_Access/index.html)) - limited information, seems to be under active development but very slow
- [The Bazaar](https://playthebazaar.com/), PC, with [the Bazaar Access mod](https://github.com/Ali-Bueno/bazaar-access)) - partialy accessible, more info available [here](https://forum.audiogames.net/topic/58335/)
- [The Drifter](https://store.steampowered.com/app/1170570/The_Drifter/), PC, with [this mod](https://github.com/Lirin111/the-drifter-accessibility-mod)) - limited information
- [The Elder Scrolls V: Skyrim Anniversary Edition](https://store.steampowered.com/sub/626153/), PC, with [the Skyrim Access mod](https://gitlab.com/BlindModeModProject/Mods/SkyrimAccess)) - work in progress, development has been slow for a while
- [The Last of Us part I.](https://store.steampowered.com/app/1888930/The_Last_of_Us_Part_I/), PC/PS5) - fully accessible w/audio description
...
- [Torment Hexus](https://store.steampowered.com/app/3238420/Torment_Hexus/), PC) - work in progress, under active development
...
- [World of Warcraft](https://worldofwarcraft.blizzard.com/), PC, with [the Blind Slash mod](https://www.curseforge.com/wow/addons/blindslash)) - mostly accessible, sighted assistance required in dungeons and end-game content
- [World of Warcraft Classic](https://worldofwarcraft.blizzard.com/wowclassic), PC, with [the SKU mod](https://www.curseforge.com/wow/addons/sku)) - not in active development as seen by the notice in the description. As such, I don't recommend it to new players, but I'm putting it here just to make it clear it exists for now.
- [WorldBox](https://store.steampowered.com/app/1206560/WorldBox__God_Simulator/), PC, with [the WorldBox Access mod](https://github.com/Makenann/WorldBoxAccess/)) - mostly accessible
...
These are games that are playable, but without the developers or modders specifically including accessibility for us. Experience with these games may vary.
- Most fighting games (e.g. older [Mortal Kombat](https://www.mortalkombat.com/))
- [Rhythm Heaven](https://www.nintendo.com/us/store/products/rhythm-heaven-megamix-3ds/), Nintendo 3DS) - accidentally playable, menu guide available [here](https://forum.audiogames.net/topic/19099/rhythm-heaven-megamix-menu-guide/)
- [13 Sentinels: Aegis Rim](https://atlus.com/13sentinels/), PS4/PS5/Switch) - playable, more information and guide available [here](https://breakdownwalls.net/wp-content/uploads/2021/02/13-Sentinels-Guide.html)
- [Ninja Gaiden 3](https://store.steampowered.com/app/1369760/NINJA_GAIDEN_3_Razors_Edge_NINJA_GAIDEN_Master_Collection/)): OCR required, has navigation assist which makes it playable
- [Resident Evil 6](https://store.steampowered.com/app/221040/Resident_Evil_6/)): OCR required, has navigation assist which makes it playable.
- [The Jackbox party pack series](https://www.jackboxgames.com/)), from volume 7 upwards including the starter pack. These are social games that work by having one player run the game and show it to others, either IRL on a tv or through a stream on a platform like Discord. The game menus are not narrated, but each minigame has unique music in the selection menu, and once a game is selected you can press up arrow on PC to have the room code read outloud. The web interface for the players is where most of the accessibility is as all visual elements, such as leaderboard changes, are audio described by screen readers. Accessibility for the specific minigames varies, but in general anything which doesn’t involve drawing, i.e. any word, trivia or creative writing games are fully accessible. Older games in the series from volume 6 down also have a few playable games, but don’t have the room code reading or enhanced audio descriptions on the website.
- [Ninja Gaiden 4](https://store.steampowered.com/app/2627260/NINJA_GAIDEN_4/)) - OCR required, has navigation assist which makes it playable
- [Animal Crossing: New Horizons](https://www.nintendo.com/us/store/products/animal-crossing-new-horizons-switch/)) - OCR required, has very good sound design and sound cues for almost everything in the game and is also very customizable
- [Final Fantasy XVI](https://store.steampowered.com/app/2515020/FINAL_FANTASY_XVI/)) - has accidental navigation assist (animal instinct) which makes it technically somewhat playable
